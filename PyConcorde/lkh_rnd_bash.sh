...
python concorde_solve.py --dask_parallel --type ATSP --data_dir $data_dir --data rnd_N20_I1000_S_seed1234_iter4.pkl --solver lkh\
 --redo_failed --out_prefix TEST0_Dask_LKH --clear 10 --save 10 --scale 1000 --log LKH_rnd_20.log --tmp_log_dir $tmp_dir
